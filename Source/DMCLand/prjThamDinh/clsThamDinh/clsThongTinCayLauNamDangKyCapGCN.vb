...
Public Class clsThongTinCayLauNamDangKyCapGCN
    ...
    ''' <summary>
    ''' Danh sách CÂY LÂU NĂM đăng ký cấp GCN 
    ''' </summary>
    ''' <returns>Giá trị trả về là bảng danh sách nhà ở cấp GCN</returns>
    ''' <remarks></remarks>
    Public Function SelectThongTinCayLauNamDangKyCapGCNByMaHoSoCapGCN() As DataTable
        Dim dtResults As New DataTable
        Me.GetData(dtResults)
        Return dtResults
    End Function
    ''' <summary>
    ''' Phương thức truy vấn Danh sách thông tin Cây lâu năm đăng ký cấp GCN
    ''' </summary>
    ...
    Private Function GetData(ByRef dtResults As DataTable) As String
        ...
        Try
            ...
            If Database.OpenConnection = True Then
                ...
                Database.getValue(dtResults, "spSelectThongTinCayLauNamDangKyCapGCNByMaHoSoCapGCN", Paras, Values)
