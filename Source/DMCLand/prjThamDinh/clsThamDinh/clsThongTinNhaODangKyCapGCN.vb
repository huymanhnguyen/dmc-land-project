...
Public Class clsThongTinNhaODangKyCapGCN
    ...
    ''' <summary>
    ''' Danh sách NHÀ Ở đăng ký cấp GCN 
    ''' </summary>
    ''' <returns>Giá trị trả về là bảng danh sách nhà ở cấp GCN</returns>
    ''' <remarks></remarks>
    Public Function SelectThongTinNhaODangKyCapGCNByMaHoSoCapGCN() As DataTable
        Dim dtResults As New DataTable
        Me.GetData(dtResults)
        Return dtResults
    End Function
    ''' <summary>
    ''' Phương thức truy vấn Danh sách thông tin Nhà ở đăng ký cấp GCN
    ''' </summary>
    ...
    Private Function GetData(ByRef dtResults As DataTable) As String
        ...
        Try
            ...
            If Database.OpenConnection = True Then
                ...
                Database.getValue(dtResults, "spSelectThongTinNhaODangKyCapGCNByMaHoSoCapGCN", Paras, Values)
