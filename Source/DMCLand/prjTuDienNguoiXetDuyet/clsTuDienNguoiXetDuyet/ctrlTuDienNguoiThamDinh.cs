...
{
    public partial class ctrlTuDienNguoiThamDinh : UserControl
    {
        public ctrlTuDienNguoiThamDinh()
        {
            InitializeComponent();
        }
        ...
        {
            //Khai báo và khởi tạo đối tượng Từ điển người THẨM ĐỊNH
            ...
            try
            {
                ...
                if (shortAction == 0)
                {
                    strResults = TuDien.SelectTuDienCanBoThamDinh(ref dtTuDien);
                }
                else if (shortAction == 1)
                {
                    strResults = TuDien.InsertTuDienCanBoThamDinh(ref str);
                }
                else if (shortAction == 2)
                {
                    strResults = TuDien.UpdateTuDienCanBoThamDinh(ref str);
                }
                else if (shortAction == 3)
                {
                    strResults = TuDien.DeleteTuDienCanBoThamDinh(ref str);
                }
            ...
            {
                strError = ex.Message;
                System.Windows.Forms.MessageBox.Show(" Cập nhật dữ liệu " + System.Environment.NewLine + " Từ điển người THẨM ĐỊNH " + " Lỗi: " + ex.Message.ToString(), "DMCLand", MessageBoxButtons.OK);
            }
        }
        ...
        public void showData()
        {
            try
            {
                /* Khởi tạo đối tượng dtTuDienNguoiThamDinh */
                dtTuDien = new DataTable();
                /* Khởi tạo từ điển THẨM ĐỊNH */
                DMC.Land.TuDienCanBoNhiepVu.clsTuDienCanBoNghiepVu TuDien = new DMC.Land.TuDienCanBoNhiepVu.clsTuDienCanBoNghiepVu();
                ...
                if (TuDien.SelectTuDienCanBoThamDinh(ref  dtTuDien) == "")
                {
                    /* Hiển thị dữ liệu lên Grid */
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show(" Hiển thị dữ liệu Từ điển người Thẩm định " + System.Environment.NewLine +
        ...
        private void FormatGridContruction()
        {
            ...
            catch (Exception ex)
            {
                strError = "";
                strError = ex.ToString();
                MessageBox.Show(" Thiết đặt hiển thị Từ điển người Thẩm định " + System.Environment.NewLine +
                    "Lỗi: " + System.Environment.NewLine + ex.ToString(), "DMCLand");
            }
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            {
                System.Windows.Forms.MessageBox.Show(this, " Bạn phải chọn Người THẨM ĐỊNH cần xóa!", "DMCLand", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            /* Trang thai cap nhat */
        ...
        private void btnCapNhat_Click(object sender, EventArgs e)
        {
            ...
            {
                System.Windows.Forms.MessageBox.Show(this, "Bạn phải nhập Họ tên người THẨM ĐỊNH!", "DMCLand", MessageBoxButtons.OK, MessageBoxIcon.Information);
                txtHoTen.Focus();
                return;
            }
            /* Cập nhật thông tin người THẨM ĐỊNH */
            this.UpdateData();
        ...
        private void ctrlTuDienNguoiXetDuyet_Load(object sender, EventArgs e)
        {
            ...
            {
                strError = ex.Message;
                System.Windows.Forms.MessageBox.Show(this, " Nạp dữ liệu ban đầu " + System.Environment.NewLine + " Từ điển người THẨM ĐỊNH " +
        ...
        private void grdvwTuDien_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            if (e.RowIndex >= 0)
            {
                ...
                {
                    strError = ex.Message;
                    System.Windows.Forms.MessageBox.Show(this, " Hiển thị dữ liệu lên Form " + System.Environment.NewLine + "TỪ ĐIỂN CÁN BỘ THẨM ĐỊNH" +
        ...
        private void grdvwTuDien_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                {
                    int  RowID = Convert.ToInt16 (grdvwTuDien.CurrentRow.Cells["STT"].Value) - 1;
                    /* Xác định Mã người THẨM ĐỊNH */
                    strMa = dtTuDien.Rows[RowID]["Ma"].ToString();
                    /* Khởi tạo đối tượng DataTable chứa bản ghi (THÔNG TIN NGƯỜI THẨM ĐỊNH) được lựa chọn */
                    dtTuDienSelect = new DataTable(); 
                    /* Copy định dạng của đối tượng dt.. vào đối 
                     tượng DataTable chứa bản ghi (Thông tin NGƯỜI THẨM ĐỊNH) được lựa chọn */
                    dtTuDienSelect = dtTuDien.Clone();
                    /* Add bản những Người THẨM ĐỊNH được lựa chọn vào biến kiểu DataTable dùng chung */
                    dtTuDienSelect.ImportRow(dtTuDien.Rows[RowID]);
                    /* Ẩn Form tra cứu thông tin NGƯỜI THẨM ĐỊNH */
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            {
                System.Windows.Forms.MessageBox.Show(this, " Bạn phải chọn Người THẨM ĐỊNH cần sửa thông tin!", "DMCLand", MessageBoxButtons.OK);
            }
        }
