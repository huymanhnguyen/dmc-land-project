...
Partial Class frmReportBienBanXetDuyet
    ...
    Private Sub InitializeComponent()
        Me.CtrBienBanXetDuyetCapGCN1 = New ctrBienBanXetDuyetCapGCN
        Me.SuspendLayout()
        '
    ...
    End Sub
    Friend WithEvents CtrBienBanXetDuyetCapGCN1 As DMC.Land.BienBanXetDuyetCapGCN.ctrBienBanXetDuyetCapGCN
End Class
