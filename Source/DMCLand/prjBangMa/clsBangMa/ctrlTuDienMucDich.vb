...
Public Class ctrlTuDienMucDich
    ...
    Public Sub ShowData()
        ...
        Try
            ...
            With Me.grdvwBangMa
                ...
                If BangMa.SelectMucDichSuDung(dtBangMa) = "" Then
    ...
    Public Sub NhatKyNguoiDung(ByVal ChucNang As String, ByVal MoTa As String)
        ...
        clsNhatky.NghiepVu = "Cập nhật từ điển mục đích sử dụng đất"
    ...
    Private Sub grdvwBangMa_CellMouseClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellMouseEventArgs) Handles grdvwBangMa.CellMouseClick
        ...
        If e.RowIndex >= 0 Then
            Try
                ...
                End With
            Catch ex As Exception
                MsgBox(" Bảng mã MỤC ĐÍCH SỬ DỤNG ĐẤT " & vbNewLine & " Lỗi: " & vbNewLine & ex.Message, MsgBoxStyle.Information, "DMCLand")
            End Try
        End If
    End Sub
