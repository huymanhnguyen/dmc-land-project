...
Public Class ctrlTuDienDoiTuongSuDungDat
    ...
    Private Sub FormatGridContruction()
        ...
        Catch ex As Exception
            strError = ex.Message
            MsgBox(" ĐỐI TƯỢNG SỬ DỤNG ĐẤT" + vbNewLine + " Lỗi: " & vbNewLine & strError, MsgBoxStyle.Information, "DMCLand")
        End Try
    End Sub
    ...
    Private Sub btnBangMaXoa_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnXoa.Click
        ...
        If strKyHieu <> "" Then
            ...
            End If
        Else
            MsgBox(" Bạn chưa chọn ĐỐI TƯỢNG SỬ DỤNG ĐẤT cần xóa!", MsgBoxStyle.Information, "DMCLand")
        End If
        'Trạng thái ban đầu
        Me.TrangThaiBanDau()
    ...
    Public Sub btnBangMaCapNhat_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCapNhat.Click
        ...
        If txtBangMaKyHieu.Text.Trim = "" Then
            MsgBox("Bạn phải nhập ĐỐI TUỢNG SỬ DỤNG ĐẤT!", MsgBoxStyle.Information, "DMCLand")
        ...
        Catch ex As Exception
            strError = ex.Message
            MsgBox(" Cập nhật dữ liệu " & vbNewLine & " ĐỐI TƯỢNG SỬ DỤNG ĐẤT " & vbNewLine _
    ...
    Public Sub ShowData()
        ...
        Try
            ...
            With Me.grdvwBangMa
                ...
                If BangMa.SelectDoiTuongSuDungDat(dtBangMa) = "" Then
    ...
    Public Sub NhatKyNguoiDung(ByVal ChucNang As String, ByVal MoTa As String)
        ...
        clsNhatky.NghiepVu = "Cập nhật đối tượng sử dụng đất"
    ...
    Private Sub grdvwBangMa_CellMouseClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellMouseEventArgs) Handles grdvwBangMa.CellMouseClick
        ...
        If e.RowIndex >= 0 Then
            Try
                ...
                End With
            Catch ex As Exception
                MsgBox(" Bảng mã ĐỐI TƯỢNG SỬ DỤNG ĐẤT " & vbNewLine & " Lỗi: " & vbNewLine & ex.Message, MsgBoxStyle.Information, "DMCLand")
            End Try
        End If
    End Sub
    ...
    Private Sub btnSua_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSua.Click
        If strKyHieu <> "" Then
            ...
            TrangThaiCapNhat(True)
        Else
            MsgBox(" Bạn CHƯA chọn ĐỐI TƯỢNG SỬ DỤNG ĐẤT CẦN SỬA!", MsgBoxStyle.Information, "DMCLand")
        End If
    End Sub
    ...
    Private Sub CtrlTuDienNguonGoc_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            'Trang thai cap nhat
            Me.TrangThaiCapNhat()
            'Trang thai chuc nang
