...
Public Class ctrlChuTCDN
    ...
    Public Sub NhatKyNguoiDung(ByVal ChucNang As String, ByVal MoTa As String)
        ...
        clsNhatky.NghiepVu = "Cập nhật chủ TCDN"
    ...
    Public Sub UpdateData()
        ...
        Try
            ...
            ChuTCDN.DongSoHuu = Me.chkDongSoHuu.Checked
            ChuTCDN.CayLauNam = Me.chkChuCayLauNam.Checked
            ChuTCDN.CongTrinh = Me.chkChuCongTrinhXayDung.Checked
            ChuTCDN.Dat = Me.chkChuDat.Checked
            ChuTCDN.NhaO = Me.chkChuNhaO.Checked
            ChuTCDN.RungCay = Me.chkChuRungCay.Checked
            Dim str As String = ""
...
#End Region
    ...
    Private Sub btnTraCuu_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnTraCuu.Click
        ...
        Try
            ...
            'Tổ chức, doanh nghiệp tương ứng với Giá trị là TCDN
            TraCuu.CtrlTraCuu.Nhom = "TCDN"
        ...
        If e.RowIndex >= 0 Then
            Try
                ...
                With dtChuTCDN.Rows(e.RowIndex)
                    ...
                    ChuTCDN.CayLauNam = .Item("CayLauNam").ToString
                    ChuTCDN.CongTrinh = .Item("CongTrinhXayDung").ToString
                    ChuTCDN.Dat = .Item("Dat").ToString
                    ChuTCDN.NhaO = .Item("NhaO").ToString
                    ChuTCDN.DongSoHuu = .Item("DongSoHuu").ToString
                    ChuTCDN.RungCay = .Item("RungCay").ToString
                End With
                ...
                With Me
                    ...
                    If ChuTCDN.CayLauNam.ToString <> "" Then
                        .chkChuCayLauNam.Checked = ChuTCDN.CayLauNam
                    Else
                        .chkChuCayLauNam.Checked = False
                    End If
                    If (ChuTCDN.CongTrinh.ToString <> "") Then
                        .chkChuCongTrinhXayDung.Checked = ChuTCDN.CongTrinh
                    Else
                        .chkChuCongTrinhXayDung.Checked = False
                    End If
                    If (ChuTCDN.Dat.ToString <> "") Then
                        .chkChuDat.Checked = ChuTCDN.Dat
                    Else
                        .chkChuDat.Checked = False
                    End If
                    If (ChuTCDN.DongSoHuu.ToString <> "") Then
                        .chkDongSoHuu.Checked = ChuTCDN.DongSoHuu
                    Else
                        .chkDongSoHuu.Checked = False
                    End If
                    If (ChuTCDN.NhaO.ToString <> "") Then
                        .chkChuNhaO.Checked = ChuTCDN.NhaO
                    Else
                        .chkChuNhaO.Checked = False
                    End If
                    If (ChuTCDN.RungCay.ToString <> "") Then
                        .chkChuRungCay.Checked = ChuTCDN.RungCay
                    Else
                        .chkChuRungCay.Checked = False
                    End If
