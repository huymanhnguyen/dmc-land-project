Public Class clsChuGDCN
    ...
    Dim Paras() As String = {"@MaHoSoCapGCN", "@MaChu", "@QuanHe", _
        ...
        , "@CayLauNam", "@DaChet", "@DongSoHuu", "@LoaiCSD", "@DinhDanh"}
    ...
    Private strDongSoHuu As String = ""
    Private strLoaiCSD As String = ""
    ...
    Public Property DongSoHuu() As String
        ...
        End Set
    End Property
    Public Property LoaiCSD() As String
        Get
            Return strLoaiCSD
        End Get
        Set(ByVal value As String)
    ...
    Public Function Execute(ByRef records As String, ByVal strStoreProcedureName As String) As String
        Try
            ...
            If Database.OpenConnection = True Then
                ...
                {strMaHoSoCapGCN, strMaChu, strQuanHe, _
                    ...
                    , strDat, strNhaO, strCongTrinhXayDung, strRungCay _
                    , strCayLauNam, blnDaChet, strDongSoHuu, strLoaiCSD, strDinhDanh}
