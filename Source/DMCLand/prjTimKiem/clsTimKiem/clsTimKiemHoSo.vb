...
Public Class clsTimKiemHoSo
    ...
    Private paraHoSo() As String = {"@MaDonViHanhChinh", "@TrangThaiHoSoCapGCN", "@SoPhatHanhGCN", "@SoVaoSoCapGCN", "@SoQuyetDinhCapGCN", "@SoHoSo", "@SoThuTuHoSo", "@IsCoBanDo", "@MaNguonGocHoSo", "@KetHopDK"} '{"@MaDonViHanhChinh", "@HoanTatHoSoKeKhai", "@HoanTatThamDinh", "@HoanTatPheDuyet", "@SoPhatHanhGCN", "@SoVaoSoCapGCN", "@SoQuyetDinhCapGCN", "@HoanTatCapGCN", "@SoHoSo", "@SoThuTuHoSo"}
    Private paraChuSuDung() As String = {"@MaDonViHanhChinh", "@TenChuSuDung", "@SoDinhDanh", "@IsCoBanDo", "@IsCoBienDong"}
    ...
    Private strIsBienDong As String = ""

    Private strNamTrinh As String
    Private strSoToTrinh As String
    Private strNgayQuyetDinhCapGCN As String
    Private strMaNguonGocHoSo As String
    Private strKetHopDK As String

    Public Property KetHopDK() As String
        Get
            Return strKetHopDK
        End Get
        ...
        End Set
    End Property
    Public Property MaNguonGocHoSo() As String
        Get
            Return strMaNguonGocHoSo
        End Get
        Set(ByVal value As String)
            strMaNguonGocHoSo = value
        End Set
    End Property
    ...
    Public Property IsBanDo() As String
        ...
        End Set
    End Property
    Public Property IsBienDong() As String
        Get
            Return strIsBienDong
        End Get
        Set(ByVal value As String)
            strIsBienDong = value
        End Set
    ...
    Public Function SelectHoSo() As DataTable
        ...
        Try
            ...
            Dim Values() As String = {strMaDonViHanhChinh, strTrangThaiHoSoCapGCN, strSoPhatHanhGCN, strSoVaoSoCapGCN, strSoQuyetDinhCapGCN, strHoSo, strSoThuTuHoSo, strIsBanDo, strMaNguonGocHoSo, strKetHopDK}
    ...
    Public Function SelectChu() As DataTable
        ...
        Dim strError As String = ""
        Try
            If strIsBienDong Is Nothing Then
                strIsBienDong = "0"
            End If
            Dim Values() As String = {strMaDonViHanhChinh, strTenChu, strSoDinhDanh, strIsBanDo, strIsBienDong}
    ...
    Public Function SelectTongHopChuChuyenNhuong() As DataTable
        Dim dt As New DataTable
        Dim strError As String = ""
        Try
            '"@MaDonViHanhChinh", "@TenChuSuDung", "@SoDinhDanh"
            Dim Values() As String = {strMaHoSoCapGCN}
            dt = TimKiemHoSoThuaDat("spSelectThongTinChuChuyenNhuongByMaHoSoCapGCN", Values, paraChu)
        Catch ex As Exception
            strError = ex.Message
        End Try
        Return dt
    ...
    Public Function SelectLoaiBienDong() As DataTable
        Dim dt As New DataTable
        Dim strError As String = ""
        Try
            Dim paraMaXa() As String = {"@MaHoSoCapGCN"}
            Dim Values() As String = {strMaHoSoCapGCN}
            dt = TimKiemHoSoThuaDat("spSelectLoaiBienDongByHoSoCapGCN", Values, paraMaXa)
        Catch ex As Exception
            strError = ex.Message
        End Try
        Return dt
    ...
    Public Function GetNguonCapHoSo() As DataTable
        Dim dt As New DataTable
        Dim strError As String = ""
        Try
            Dim paraMaXa() As String = {"@flag"}
            Dim Values() As String = {"0"}
            dt = TimKiemHoSoThuaDat("spNguonChuyenHoSo", Values, paraMaXa)
        Catch ex As Exception
            strError = ex.Message
        End Try
        Return dt
