...
Public Class ctrlChuSoHuuCayLauNamTCDN
    ...
    Public Sub AddColumnsToChucDoanhNghiep()
        ...
        Catch ex As Exception
            strError = ex.Message
            MsgBox(" Chủ sở hữu Cây lâu năm " & vbNewLine & " Lỗi: " & vbNewLine & strError, MsgBoxStyle.Information, "DMCLand")
        End Try
    End Sub
    ...
    Private Sub FormatGridContruction()
        ...
        Catch ex As Exception
            strError = ex.Message
            MsgBox(" Chủ sở hữu Cây lâu năm - Tổ chức, Doanh nghiệp " & vbNewLine & " Lỗi: " & vbNewLine & strError, MsgBoxStyle.Information, "DMCLand")
        End Try
    End Sub
    ...
    Private Sub btnCapNhat_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCapNhat.Click
        ...
        If strMaTaiSan = "" Then
            System.Windows.Forms.MessageBox.Show("Bạn phải lựa chọn Chủ sở hữu Cây lâu năm", "DMCLand", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            Exit Sub
        End If
        With Me
    ...
    End Sub
    ''' <summary>
    ''' Hiển thị thông tin Chủ sở hữu Cây lâu năm lên Grid
    ''' </summary>
    ''' <remarks></remarks>
    Public Sub ShowData()
        ...
        Try
            ...
            With Me
                ...
                If ChuSoHuu.SelectChuSoHuuCayLauNamByTCDN(dtChuTCDN) = "" Then
    ...
    Private Sub btnGhi_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGhi.Click
        ...
        If txtMaDoiTuong.Text.Trim = "" Then
            MsgBox("Bạn phải nhập Mã đối tượng sở hữu Cây lâu năm!", MsgBoxStyle.Information, "DMCLand")
            txtMaDoiTuong.Focus()
            Exit Sub
        End If
        With Me
    ...
    End Sub
    ''' <summary>
    ''' Xóa Chủ sở hữu Cây lâu năm (bảng trung gian tblChuSoHuu)
    ...
    Public Sub UpdateData()
        ...
        Try
            ...
            'Khai báo nhận chuỗi kết nối Database
            ChuSoHuu.Connection = strConnection
            'Gán giá trị cho thuộc tính của đối tượng Cây lâu năm
            'Mã Cây lâu năm ()
            ChuSoHuu.MaTaiSan = strMaTaiSan
            'Mã Chủ Cây lâu năm ()
    ...
    Private Sub grdvwTChucDNghiep_CellMouseClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellMouseEventArgs) Handles grdvwTChucDNghiep.CellMouseClick
        ...
        If e.RowIndex >= 0 Then
            Try
                'Hiển thị thông tin Chủ sở hữu Cây lâu năm ()
