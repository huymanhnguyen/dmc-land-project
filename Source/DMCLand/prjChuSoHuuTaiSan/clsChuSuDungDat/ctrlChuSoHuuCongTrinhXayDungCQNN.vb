...
Public Class ctrlChuSoHuuCongTrinhXayDungCQNN
    ...
    End Sub
    ''' <summary>
    ''' Hiển thị thông tin Chủ sở hữu Công trình xây dựng trong lên Grid
    ''' </summary>
    ''' <remarks></remarks>
    Public Sub ShowData()
        ...
        Try
            ...
            With Me
                ...
                If ChuSoHuu.SelectChuSoHuuCongTrinhXayDungByCQNN(dtChuSoHuuCQNN) = "" Then
    ...
    Private Sub btnGhi_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGhi.Click
        ...
        End If
        With Me
            'Cập nhật thông tin Chủ sở hữu Công trình xây dựng (Hồ gia đình - cá nhân)
            .UpdateData()
            'Hiển thị thông tin Chủ sở hữu Công trình xây dựng lên Form
            .ShowData()
    ...
    ''' <summary>
    ''' Thêm Chủ sở hữu Công trình xây dựng
    ...
    Public Sub UpdateData()
        ...
        Try
            ...
            If (strConnection = "") Then
                MessageBox.Show("Chắc chắn rằng tồn tại chuỗi kết nối cơ sở dữ liệu", "DMCLand", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            End If
            'Chắc chắn rằng tồn tại Mã Công trình xây dựng
            If (strMaTaiSan = "") Then
            ...
            If (strMaChu = "") Then
                ...
                Exit Sub
            End If
            'GÁN GIÁ TRỊ CHO THUỘC TÍNH CỦA ĐỐI TƯỢNG CHỦ SỞ HỮU Công trình xây dựng
            'Khai báo nhận chuỗi kết nối Database
            ChuSoHuu.Connection = strConnection
            'Mã Hồ sơ cấp GCN
            ChuSoHuu.MaTaiSan = strMaTaiSan
