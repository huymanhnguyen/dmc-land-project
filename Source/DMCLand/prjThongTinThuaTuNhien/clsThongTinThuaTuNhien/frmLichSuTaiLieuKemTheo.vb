...
Public Class frmLichSuTaiLieuKemTheo
    ...
    'Khai báo biến lưu thông tin Lịch sử TÀI LIỆU KÈM THEO
    Private dtLichSuTaiLieuKemTheo As New DataTable
    ...
    Public Sub FormatGridContruction()
        Try
            With Me.grdvw
                ...
                With .Columns("TenTepDuLieuNguon")
                    .HeaderText = "Tệp nguồn tài liệu"
                    .Width = 130
                    .Visible = True
                End With
                '
                With .Columns("TaiLieu")
                    .HeaderText = "Tài liệu"
                    .Width = 150
                    .Visible = True
                End With
        ...
        Catch ex As Exception
            strError = ex.Message
            MsgBox(" Hiển thị thông tin lịch sử TÀI LIỆU KÈM THEO sử dụng thửa đất" + vbNewLine + strError, MsgBoxStyle.Information, "DMCLand")
        End Try
    End Sub

    Public Sub ShowData()
        'Cập nhật thông tin Lịch sử TÀI LIỆU KÈM THEO
        Dim LichSuTaiLieuKemTheo As New clsThongTinHoSoCapGCNThuaDatLichSu
        LichSuTaiLieuKemTheo.Connection = strConnection
        LichSuTaiLieuKemTheo.MaThuaDatLichSu = strMaThuaDatLichSu
        LichSuTaiLieuKemTheo.MaDonViHanhChinh = strMaDonViHanhChinh

        'Làm sạch dữ liệu trên đối tượng Datatable
        dtLichSuTaiLieuKemTheo.Clear()
        'Nạp thông tin Lịch sử TÀI LIỆU KÈM THEO vào đối tượng Datatable
        LichSuTaiLieuKemTheo.SelectThongTinLichSuTaiLieuKemTheo(dtLichSuTaiLieuKemTheo)
        'Hiển thị thông tin Lịch sử TÀI LIỆU KÈM THEO lên Form
        With Me.grdvw
            .ClearSelection()
            'Trình bày dữ liệu grdvw
            .DataSource = dtLichSuTaiLieuKemTheo
            If dtLichSuTaiLieuKemTheo.Rows.Count > 0 Then
    ...
    Private Sub btnGhi_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGhi.Click
        If (MessageBox.Show("Bạn có muốn sao chép LỊCH SỬ TÀI LIỆU KÈM THEO vào hồ sơ cấp GCN này không?", "DMCLand", MessageBoxButtons.YesNo, MessageBoxIcon.Information) = DialogResult.Yes) Then
            Dim LichSuTaiLieuKemTheo As New clsThongTinHoSoCapGCNThuaDatLichSu
            With LichSuTaiLieuKemTheo
                ...
                'Sao chép thông tin lịch sử TÀI LIỆU KÈM THEO
                'vào Hồ sơ cấp GCN hiện thời
                .SaoChepThongTinLichSuTaiLieuKemTheo()
            End With
        End If
        'Thoát Form
        Me.Hide()
