...
Public Class clsTrangThaiHoSo
    Dim Paras() As String = {"@flag", "@MaHoSoCapGCN", "@TrangThai", "@MaDonVIHanhChinh"}
    ...
    Public Function Excecute(ByVal strStoreProcedureName As String, ByRef records As String) As String
        Try
            ...
            If DataBase.OpenConnection = True Then
                ...
                Dim Values() As String = {0, strMaHoSoCapGCN, strMaXacNhan, strMaDonViHanhChinh}
    ...
    Public Function SelTrangThaiHoSo() As DataTable
        Dim dt As New DataTable
        Dim para() As String = {"@flag", "@MaHoSoCapGCN", "@MaDonVIHanhChinh"}
        Dim value() As String = {1, strMaHoSoCapGCN, strMaDonViHanhChinh}
        dt = GetData("spUpdateTrangThaiHoSoCapGCN", value, para)
        Return dt
    End Function
    Public Function SelGiaTriTrangThaiHoSoHienTHoi() As DataTable
        Dim dt As New DataTable
        Dim para() As String = {"@flag", "@MaHoSoCapGCN", "@MaDonVIHanhChinh"}
        Dim value() As String = {3, strMaHoSoCapGCN, strMaDonViHanhChinh}
        dt = GetData("spUpdateTrangThaiHoSoCapGCN", value, para)
        Return dt
    End Function
End Class
