...
namespace DMC.Land.InThongBaoCapGCN
{
    class clsInThongBaoCapGCN
    {
        ...
        private string[] parap = { "@MaDonViHanhChinh" };
   ...
   public void getValue(DataTable dtResult, string strSP, string[] strPara, string[] strValues)
   {
    ...
    public DataTable selectToTrinh(){
        DataTable dt = new DataTable();
        string strError = "";
        try {
            string[] Values = { strMaHoSoCapGCN };
            dt = GetTable("SP_SelectToTrinhDiaChinh", Values, Para);
            strError = "";
         }
        catch (Exception ex)
        {
    ...
    public DataTable selectThamDinh()
    {
        DataTable dt = new DataTable();
        string strError = "";
        try
        {
            string[] Values = { strMaHoSoCapGCN };
            dt = GetTable("SP_SelectThamDinh", Values, Para);
            strError = "";
        }
        catch (Exception ex)
        {
    ...
    public DataTable selectTenDVHC()
    {
        DataTable dt = new DataTable();
        string strError = "";
        try
        {
            ...
            dt = GetTable("selectTenDVHC", Values, parap );
            strError = "";
        }
        catch (Exception ex)
        {
