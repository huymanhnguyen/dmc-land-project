...
Public Class clsThongTinCongTrinhXayDungDangKyCapGCN
    ...
    ''' <summary>
    ''' Danh sách CÔNG TRÌNH XÂY DỰNG KHÔNG PHẢI LÀ NHÀ Ở đăng ký cấp GCN 
    ''' </summary>
    ''' <returns>Giá trị trả về là bảng danh sách nhà ở cấp GCN</returns>
    ''' <remarks></remarks>
    Public Function SelectThongTinHangMucCongTrinhDangKyCapGCNByMaHoSoCapGCN() As DataTable
        Dim dtResults As New DataTable
        Me.GetData(dtResults)
        Return dtResults
    End Function
    ''' <summary>
    ''' Phương thức truy vấn Danh sách thông tin CÔNG TRÌNH XÂY DỰNG đăng ký cấp GCN
    ''' </summary>
    ...
    Private Function GetData(ByRef dtResults As DataTable) As String
        ...
        Try
            ...
            If Database.OpenConnection = True Then
                ...
                Database.getValue(dtResults, "spSelectThongTinHangMucCongTrinhDangKyCapGCNByMaHoSoCapGCN", Paras, Values)
