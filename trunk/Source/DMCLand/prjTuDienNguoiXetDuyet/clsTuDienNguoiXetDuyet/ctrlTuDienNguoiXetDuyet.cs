...
{
    public partial class ctrlTuDienNguoiXetDuyet : UserControl
    {
        public ctrlTuDienNguoiXetDuyet()
        {
            InitializeComponent();
        }
        ...
        /* Khai báo đối tượng kiểu Datatable nhận dữ liệu từ bảng Từ điển
         người xét duyệt */
        private DataTable dtTuDienNguoiXetDuyet = new DataTable();

        public DataTable  dtTuDienNguoiXetDuyetSelect = new DataTable ();
        ...
        {
            //Khai báo và khởi tạo đối tượng Từ điển người xét duyệt
            clsTuDienCanBoNghiepVu TuDienNguoiXetDuyet =  new clsTuDienCanBoNghiepVu();
            try
            {
                //Gán chuỗi kết nối Database
                TuDienNguoiXetDuyet.Conneciton  = strConnection ;
                TuDienNguoiXetDuyet.Ma = strMa;
                TuDienNguoiXetDuyet.ChucDanh = txtChucDanh.Text.Trim();
                TuDienNguoiXetDuyet.ChucVu  = txtChucVu.Text.Trim();
                TuDienNguoiXetDuyet.HoTen = txtHoTen.Text.Trim() ;
                if (cmbGioiTinh.Text.Trim() == "Nam")
                {
                    TuDienNguoiXetDuyet.GioiTinh = "1";
                }
                else
                {
                    TuDienNguoiXetDuyet.GioiTinh = "0";
                }
                ...
                if (shortAction == 0)
                {
                    strResults = TuDienNguoiXetDuyet.SelectTuDienCanBoXetDuyet(ref dtTuDienNguoiXetDuyet);
                }
                else if (shortAction == 1 )
                {
                    strResults =  TuDienNguoiXetDuyet.InsertTuDienCanBoXetDuyet(ref str);
                }
                else if ( shortAction == 2)
                {
                    strResults =  TuDienNguoiXetDuyet.UpdateTuDienCanBoXetDuyet (ref str );
                }
                else if (shortAction == 3 )
                {
                    strResults =  TuDienNguoiXetDuyet.DeleteTuDienCanBoXetDuyet (ref str);
                }
                ...
                strError = TuDienNguoiXetDuyet.Error ;
            }
            catch ( Exception ex)
            {
                strError = ex.Message ;
        ...
        public void showData()
        {
            try
            {
                ...
                dtTuDienNguoiXetDuyet = new DataTable();
                /* Khởi tạo từ điển xét duyệt */
                clsTuDienCanBoNghiepVu TuDienNguoiXetDuyet = new clsTuDienCanBoNghiepVu();
                /* Nhận giá trị cho chuỗi kết nối cơ sở dữ liệu */
                TuDienNguoiXetDuyet.Conneciton = strConnection;
                /* Gán giá trị cho tham số cần truy vấn */
                TuDienNguoiXetDuyet.Ma = "";
                TuDienNguoiXetDuyet.GioiTinh = "";
                TuDienNguoiXetDuyet.HoTen = "";
                TuDienNguoiXetDuyet.ChucDanh = "";
                TuDienNguoiXetDuyet.ChucVu = "";
                /* Gọi phương thức getData. Nếu nhận dữ liệu thành công thì hiển thị lên Grid */
                if (TuDienNguoiXetDuyet.SelectTuDienCanBoXetDuyet(ref  dtTuDienNguoiXetDuyet) == "")
                {
                    /* Hiển thị dữ liệu lên Grid */
                    this.grdvwTuDien.DataSource = dtTuDienNguoiXetDuyet;
                    if (dtTuDienNguoiXetDuyet.Rows.Count > 0)
                    {
                    ...
                    ctrFilterGrid1.MydataTable = dtTuDienNguoiXetDuyet;
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show(" Hiển thị dữ liệu Từ điển người xét duyệt " + System.Environment.NewLine +
        ...
        private void FormatGridContruction()
        {
            ...
            catch (Exception ex)
            {
                strError = "";
                strError = ex.ToString();
                MessageBox.Show(" Thiết đặt hiển thị Từ điển người xét duyệt " + System.Environment.NewLine +
                    "Lỗi: " + System.Environment.NewLine + ex.ToString(), "DMCLand");
            }
    ...
    public void  TrangThaiCapNhat(bool  blnCapNhat)
    {
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            {
                System.Windows.Forms.MessageBox.Show (this, " Bạn phải chọn Người xét duyệt cần sửa thông tin!", "DMCLand",MessageBoxButtons.OK );
            }
        }
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            {
                System.Windows.Forms.MessageBox.Show (this," Bạn phải chọn Người xét duyệt cần xóa!", "DMCLand",MessageBoxButtons.OK ,MessageBoxIcon.Information);
            }
            /* Trang thai cap nhat */
        ...
        private void btnCapNhat_Click(object sender, EventArgs e)
        {
            ...
            {
                System.Windows.Forms.MessageBox.Show (this,"Bạn phải nhập Họ tên người xét duyệt!", "DMCLand",MessageBoxButtons.OK,MessageBoxIcon.Information);
                txtHoTen.Focus();
                return ;
            }
            /* Cập nhật thông tin người xét duyệt */
            this.UpdateData();
        ...
        private void ctrlTuDienNguoiXetDuyet_Load(object sender, EventArgs e)
        {
            ...
            {
                strError = ex.Message;
                System.Windows.Forms.MessageBox.Show(this, " Nạp dữ liệu ban đầu " + System.Environment.NewLine + " Từ điển người xét duyệt " +
        ...
        private void grdvwTuDien_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            if ( e.RowIndex >= 0)
            {
                try
                {
                    ...
                    TuDienNguoiXetDuyet.Ma = dtTuDienNguoiXetDuyet.Rows[RowID]["Ma"].ToString();
                    strMa = dtTuDienNguoiXetDuyet.Rows[RowID]["Ma"].ToString();
                    TuDienNguoiXetDuyet.ChucDanh = dtTuDienNguoiXetDuyet.Rows[RowID]["ChucDanh"].ToString();
                    TuDienNguoiXetDuyet.ChucVu = dtTuDienNguoiXetDuyet.Rows[RowID]["ChucVu"].ToString();
                    TuDienNguoiXetDuyet.HoTen = dtTuDienNguoiXetDuyet.Rows[RowID]["HoTen"].ToString();
                    if (dtTuDienNguoiXetDuyet.Rows[RowID]["GioiTinh"].ToString() == "True")
                        TuDienNguoiXetDuyet.GioiTinh = "1";
                    else if (dtTuDienNguoiXetDuyet.Rows[RowID]["GioiTinh"].ToString() == "False")
                        TuDienNguoiXetDuyet.GioiTinh = "0";
                    ...
                    /* Hiển thị dữ liệu tương ứng lên Form */
                        ...
                        /* Chức danh */
                        this.txtChucDanh.Text = TuDienNguoiXetDuyet.ChucDanh.ToString();
                        /* Chức vụ */
                        this.txtChucVu.Text = TuDienNguoiXetDuyet.ChucVu.ToString();
                        /* Họ tên */
                        this.txtHoTen.Text = TuDienNguoiXetDuyet.HoTen.ToString(); 
                        /* Giới tính */
                        if (TuDienNguoiXetDuyet.GioiTinh == "1")
                            this.cmbGioiTinh.Text = "Nam";
                        else if (TuDienNguoiXetDuyet.GioiTinh == "0")
                ...
                {
                    strError = ex.Message;
                    System.Windows.Forms.MessageBox.Show (this," Hiển thị dữ liệu lên Form " + System.Environment.NewLine  + "TỪ ĐIỂN CÁN BỘ XÉT DUYỆT" +
        ...
        private void grdvwTuDien_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                {
                    int RowID = Convert.ToInt16(grdvwTuDien.CurrentRow.Cells["STT"].Value) - 1;
                    /* Xác định Mã người xét duyệt */
                    strMa = dtTuDienNguoiXetDuyet.Rows[RowID]["Ma"].ToString();
                    /* Khởi tạo đối tượng DataTable chứa bản ghi (Thông tin Chủ sử dụng) được lựa chọn */
                    dtTuDienNguoiXetDuyetSelect  = new DataTable();
                    /* Copy định dạng của đối tượng dtChuSuDungTCDN vào đối 
                     tượng DataTable chứa bản ghi (Thông tin Chủ sử dụng) được lựa chọn */
                    dtTuDienNguoiXetDuyetSelect  = dtTuDienNguoiXetDuyet.Clone();
                    /* Add bản những Người xét duyệt được lựa chọn vào biến kiểu DataTable dùng chung */
                    dtTuDienNguoiXetDuyetSelect.ImportRow(dtTuDienNguoiXetDuyet.Rows[RowID]);
