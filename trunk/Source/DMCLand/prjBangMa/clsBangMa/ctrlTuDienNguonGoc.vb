...
Public Class ctrlTuDienNguonGoc
    ...
    Private Sub btnBangMaXoa_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnXoa.Click
        ...
        If strKyHieu <> "" Then
            ...
            End If
        Else
            MsgBox(" Bạn chưa chọn NGUỒN GỐC cần xóa!", MsgBoxStyle.Information, "DMCLand")
        End If
        'Trạng thái ban đầu
        Me.TrangThaiBanDau()
    ...
    Public Sub btnBangMaCapNhat_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCapNhat.Click
        ...
        If txtBangMaKyHieu.Text.Trim = "" Then
            MsgBox("Bạn phải nhập NGUỒN GỐC SỬ DỤNG ĐẤT!", MsgBoxStyle.Information, "DMCLand")
        ...
        Catch ex As Exception
            strError = ex.Message
            MsgBox(" Cập nhật dữ liệu " & vbNewLine & " NGUỒN GỐC SỬ DỤNG " & vbNewLine _
    ...
    Public Sub ShowData()
        ...
        Try
            ...
            With Me.grdvwBangMa
                ...
                If BangMa.SelectNguonGocSuDung(dtBangMa) = "" Then
    ...
    Public Sub NhatKyNguoiDung(ByVal ChucNang As String, ByVal MoTa As String)
        ...
        clsNhatky.NghiepVu = "Cập nhật từ điển nguồn gốc sử dụng"
    ...
    Private Sub grdvwBangMa_CellMouseClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellMouseEventArgs) Handles grdvwBangMa.CellMouseClick
        ...
        If e.RowIndex >= 0 Then
            Try
                ...
                End With
            Catch ex As Exception
                MsgBox(" Bảng mã NGUỒN GỐC SỬ DỤNG ĐẤT " & vbNewLine & " Lỗi: " & vbNewLine & ex.Message, MsgBoxStyle.Information, "DMCLand")
            End Try
        End If
    End Sub
    ...
    Private Sub btnSua_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSua.Click
        If strKyHieu <> "" Then
            ...
            TrangThaiCapNhat(True)
        Else
            MsgBox(" Bạn CHƯA chọn NGUỒN GỐC CẦN SỬA!", MsgBoxStyle.Information, "DMCLand")
        End If
    End Sub
