...
namespace DMC.GIS.Common
{
    class clsNanChinhThua
    {
        ...
        {
            string strRecords = "";
            //return this.Execute("spLuuLichSuBienDongNanChinh", strRecords);
            return this.Execute("spInsertDLieuKGianThuaDatLichSuByNanChinh", strRecords);
        }
