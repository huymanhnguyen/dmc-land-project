...
Public Class ctrBienBanXetDuyetCapGCN
    Private strMaHoSoCapGCN As String = "" '"120"
    Private conn As SqlConnection
    Private strMaDVHC As String = "" '"100241"
    Private strConnection As String = "" '"Data Source=dmc-svr\map;Initial Catalog=georgetown ;User ID=sa ;PassWord=1"
    Private strServerName As String = "" ' "dmc-svr\map"
...
nhan:
    ...
    Public Sub ctrBienbanXetDuyetHoSoCapGCN_Load()
        ...
        'reportDocument1.SetDatabaseLogon(strUID, strUpass, strServerName, strDatabase)
        ...
        If dt.Rows.Count > 0 Then
            ...
            Next
            If dtHoiDong.Rows.Count > 0 Then
