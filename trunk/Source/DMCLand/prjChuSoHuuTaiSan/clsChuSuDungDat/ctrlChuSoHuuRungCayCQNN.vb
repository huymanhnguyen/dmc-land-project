...
Public Class ctrlChuSoHuuRungCayCQNN
    ...
    End Sub
    ''' <summary>
    ''' Hiển thị thông tin Chủ sở hữu Rừng cây trong lên Grid
    ''' </summary>
    ''' <remarks></remarks>
    Public Sub ShowData()
        ...
        Try
            ...
            With Me
                ...
                If ChuSoHuu.SelectChuSoHuuRungCayByCQNN(dtChuSoHuuCQNN) = "" Then
    ...
    Private Sub btnGhi_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGhi.Click
        ...
        End If
        With Me
            'Cập nhật thông tin Chủ sở hữu Rừng cây (Hồ gia đình - cá nhân)
            .UpdateData()
            'Hiển thị thông tin Chủ sở hữu Rừng cây lên Form
            .ShowData()
    ...
    Public Sub UpdateData()
        ...
        Try
            ...
            If (strConnection = "") Then
                MessageBox.Show("Chắc chắn rằng tồn tại chuỗi kết nối cơ sở dữ liệu", "DMCLand", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            End If
            'Chắc chắn rằng tồn tại Mã Rừng cây
            If (strMaTaiSan = "") Then
            ...
            If (strMaChu = "") Then
                ...
                Exit Sub
            End If
            'Gán giá trị cho thuộc tính của đối tượng Chủ sở hữu Rừng cây
            'Khai báo nhận chuỗi kết nối Database
            ChuSoHuu.Connection = strConnection
            'Mã Hồ sơ cấp GCN
            ChuSoHuu.MaTaiSan = strMaTaiSan
