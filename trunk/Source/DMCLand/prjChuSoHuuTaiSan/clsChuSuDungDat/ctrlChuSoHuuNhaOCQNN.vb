...
Public Class ctrlChuSoHuuNhaOCQNN
    ...
    End Sub
    ''' <summary>
    ''' Hiển thị thông tin Chủ sở hữu Nhà ở (Căn hộ) trong lên Grid
    ''' </summary>
    ''' <remarks></remarks>
    Public Sub ShowData()
        ...
        Try
            ...
            With Me
                ...
                If ChuSoHuu.SelectChuSoHuuNhaOByCQNN(dtChuSoHuuCQNN) = "" Then
    ...
    Private Sub btnGhi_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGhi.Click
        ...
        End If
        With Me
            'Cập nhật thông tin Chủ sở hữu Nhà ở - Căn hộ (Hồ gia đình - cá nhân)
            .UpdateData()
            'Hiển thị thông tin Chủ sở hữu Nhà ở - Căn hộ lên Form
            .ShowData()
    ...
    Public Sub UpdateData()
        ...
        Try
            ...
            If (strConnection = "") Then
                MessageBox.Show("Chắc chắn rằng tồn tại chuỗi kết nối cơ sở dữ liệu", "DMCLand", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            End If
            'Chắc chắn rằng tồn tại Mã Nhà ở
            If (strMaTaiSan = "") Then
                strError = "Không tìm thấy Mã Nhà ở"
            ...
            If (strMaChu = "") Then
                strError = "Không tìm thấy Mã Chủ sở hữu Nhà ở"
                MessageBox.Show("Lỗi: " & strError, "DMCLand", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Exit Sub
            End If
            'GÁN GIÁ TRỊ CHO THUỘC TÍNH CỦA ĐỐI TƯỢNG CHỦ SỞ HỮU NHÀ Ở
            'Khai báo nhận chuỗi kết nối Database
            ChuSoHuu.Connection = strConnection
            'Mã Hồ sơ cấp GCN
            ChuSoHuu.MaTaiSan = strMaTaiSan
