...
Public Class ctrlChuSoHuuCongTrinhXayDungTCDN
    ...
    Public WriteOnly Property MaTaiSan() As String
        ...
        End Set
    End Property
    'Mã Chủ sở hữu Công trình xây dựng
    ...
    Public Sub AddColumnsToChucDoanhNghiep()
        ...
        Catch ex As Exception
            strError = ex.Message
            MsgBox(" Chủ sở hữu Công trình xây dựng " & vbNewLine & " Lỗi: " & vbNewLine & strError, MsgBoxStyle.Information, "DMCLand")
        End Try
    End Sub
    ...
    Private Sub FormatGridContruction()
        ...
        Catch ex As Exception
            strError = ex.Message
            MsgBox(" Chủ sở hữu Công trình xây dựng - Tổ chức, Doanh nghiệp " & vbNewLine & " Lỗi: " & vbNewLine & strError, MsgBoxStyle.Information, "DMCLand")
        End Try
    End Sub
    ...
    Private Sub btnCapNhat_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCapNhat.Click
        ...
        If strMaTaiSan = "" Then
            System.Windows.Forms.MessageBox.Show("Bạn phải lựa chọn Chủ sở hữu Công Trình xây dựng", "DMCLand", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            Exit Sub
        End If
        With Me
    ...
    End Sub
    ''' <summary>
    ''' Hiển thị thông tin Chủ sở hữu Công trình xây dựng lên Grid
    ''' </summary>
    ''' <remarks></remarks>
    Public Sub ShowData()
        ...
        Try
            ...
            With Me
                ...
                If ChuSoHuu.SelectChuSoHuuCongTrinhXayDungByTCDN(dtChuTCDN) = "" Then
    ...
    Private Sub btnGhi_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGhi.Click
        ...
        If txtMaDoiTuong.Text.Trim = "" Then
            MsgBox("Bạn phải nhập Mã đối tượng sở hữu Công trình xây dựng!", MsgBoxStyle.Information, "DMCLand")
            txtMaDoiTuong.Focus()
            Exit Sub
        End If
        With Me
    ...
    End Sub
    ''' <summary>
    ''' Xóa Chủ sở hữu Công trình xây dựng (bảng trung gian tblChuSoHuu)
    ...
    Public Sub UpdateData()
        ...
        Try
            ...
            If (strMaTaiSan = "") Then
                strError = "Không tìm thấy Mã Công trình xây dựng "
                MessageBox.Show("Lỗi: " & strError, "DMCLand", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Exit Sub
            End If
            'Chắc chắn rằng tồn tại Mã chủ sở hữu
            If (strMaChu = "") Then
                strError = "Không tìm thấy Mã Chủ sở hữu Công trình xây dựng"
                MessageBox.Show("Lỗi: " & strError, "DMCLand", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Exit Sub
            End If
            'Khai báo nhận chuỗi kết nối Database
            ChuSoHuu.Connection = strConnection
            'Gán giá trị cho thuộc tính của đối tượng Công trình xây dựng
            'Mã Công trình xây dựng ()
            ChuSoHuu.MaTaiSan = strMaTaiSan
            'Mã Chủ Công trình xây dựng ()
            ChuSoHuu.MaChuSoHuu = strMaChu
            Dim str As String = ""
            Dim strUpdateResults As String = ""
            'Xác định kiểu cập nhật
            'Trường hợp thêm mới Chủ sở hữu Công trình xây dựng ()
            If (Me.shortAction = 1) Then
                strUpdateResults = ChuSoHuu.InsertChuSoHuuCongTrinhXayDung(str)
                'Trường hợp Xóa Chủ Sở hữu Công trình xây dựng ()
    ...
    Private Sub grdvwTChucDNghiep_CellMouseClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellMouseEventArgs) Handles grdvwTChucDNghiep.CellMouseClick
        ...
        If e.RowIndex >= 0 Then
            Try
                'Hiển thị thông tin Chủ sở hữu Công trình xây dựng ()
