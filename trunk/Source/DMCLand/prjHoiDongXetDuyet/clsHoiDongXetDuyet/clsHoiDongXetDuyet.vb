...
Public Class clsHoiDongXetDuyet
    ...
    Private intMaNguoiXetDuyet As Integer
    Private intMaHoSoCapGCN As Long
    ...
    Public Function Execute1(ByRef records As String, ByVal strStoreProcedureName As String) As String
        Try
            'Khai báo và khởi tạo đối tượng clsDatabase
            Dim Database As New DMC.Database.clsDatabase
            'Nhận chuỗi kết nối Database
            ...
            If Database.OpenConnection = True Then
                'Khai báo mảng giá trị
                Int64.TryParse(strMaNguoiXetDuyet, intMaNguoiXetDuyet)
                Int16.TryParse(strMaHoSoCapGCN, intMaHoSoCapGCN)
                Dim Values() As String = _
                {intMaNguoiXetDuyet, intMaHoSoCapGCN, strIndex}
                'Kiểm tra tính tương đồng của 2 mảng dữ liệu
                If (Paras.Length <> Values.Length) Then
                    Return "Giá trị truyền vào không tương thích"
                End If
    ...
    Public Function UpdateViTrData(ByRef records As String) As String
        Return Me.Execute(records, "spUpdateHoiDongXetDuyet")
    End Function
    Public Function UpdateViTrData1(ByRef records As String) As String
        Return Me.Execute1(records, "spUpdateHoiDongXetDuyet1")
    End Function
    Public Function InsertData(ByRef records As String) As String
        Return Me.Execute(records, "spInsertHoiDongXetDuyet")
    End Function
    Public Function DeleteData(ByRef records As String) As String
        Return Me.Execute(records, "spDeleteHoiDongXetDuyet")
    End Function
    ...
    Public Function SelectHoiDongXetDuyet(ByRef dtResults As DataTable) As String
        Return GetData(dtResults, "spSelectHoiDongXetDuyet")
    End Function
End Class
